...
public class EditVocabulary extends JPanel {
    ...
    public EditVocabulary(MainActivity main) {
        this.main = main;
    ...
    private void addField() {
        JTextField wordField = cf.createTextField(words[0], 32, nextLine, 104, 35, 37);
        JLabel partLabel = cf.createLabel("|", 167, nextLine, 12, 35, 37);
        JTextField meanField = cf.createTextField(means[0], 208, nextLine, 340, 35, 37);
